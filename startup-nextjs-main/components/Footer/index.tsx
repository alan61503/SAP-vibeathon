...
const Footer = () => {
  return (
    <footer
      className="wow fadeInUp dark:bg-gradient-to-br dark:from-gray-900 dark:to-gray-800 bg-gradient-to-br from-primary/10 to-white relative z-10 rounded-t-3xl shadow-lg pt-20 md:pt-28 lg:pt-32"
      data-wow-delay=".1s"
    >
      <div className="container mx-auto px-6">
          <div className="-mx-4 flex flex-wrap gap-y-12 gap-x-8 justify-center">
            <div className="w-full px-4 md:w-1/2 lg:w-4/12 xl:w-5/12 flex flex-col items-center">
              <div className="mb-12 max-w-[360px] lg:mb-16 text-center">
      ...
      {/* Decorative SVGs for footer background */}
